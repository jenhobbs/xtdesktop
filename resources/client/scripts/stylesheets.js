...
"}",
"QScrollBar:vertical, QWidget#_welcome:vertical {",
  "border: 1px solid " + smallBoxBorderColor + ";",
  "border-radius: " + borderRadius + ";",
  "background: " + smallBoxBg + ";",
  "width: 10px;",
  "margin: 0px 0 0px 0;",
 "}",
 "QScrollBar::add-line:vertical, QWidget#_welcome::add-line:vertical {",
 ...
 "QScrollBar::add-line:horizontal {",
     ...
     "subcontrol-origin: margin;",
 "}",
 "QScrollBar::sub-line:vertical, QWidget#_welcome::sub-line:vertical {",
     "background: " + bigBoxBorderColor + ";",
     "height: 0px;",
 ...
 "QScrollBar::sub-line:horizontal {",
     ...
     "subcontrol-origin: margin;",
 "}",
"QScrollBar::down-arrow:vertical, QWidget#_welcome::down-arrow:vertical {",
     "width: 20px;",
     "height: 20px;",
"}",
"QScrollBar::up-arrow:vertical, QWidget#_welcome::up-arrow:vertical {",
     "width: 10px;",
     "height: 20px;",
"}", 
...
"QScrollBar::up-arrow:horizontal {",
     ...
     "background: " + selectedBg + ";",
"}",
"QScrollBar::add-page:vertical, QScrollBar::sub-page:vertical, QWidget#_welcome::add-page:vertical, QWidget#_welcome::sub-page:vertical {",
     "background: none;",
 "}",
"QScrollBar::handle, QWidget#_welcome::handle {",
